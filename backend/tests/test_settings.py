...
class TestGetSettings:
    def test_default_settings(self, client, default_app_settings, test_state):
        ...
        assert data["hasSyncApiKey"] is False
        assert data["hasRunwayApiKey"] is False
    ...
    def test_update_api_keys(self, client, test_state):
        r = client.post(
            ...
            json={
                ...
                "syncApiKey": "sync-key-789",
                "runwayApiKey": "rw-key-000",
            },
        )
        assert r.status_code == 200
        ...
        assert test_state.state.app_settings.sync_api_key == "sync-key-789"
        assert test_state.state.app_settings.runway_api_key == "rw-key-000"
